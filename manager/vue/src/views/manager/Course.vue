  ...
  <div>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="score" label="学分" :disabled = "user.role != 'ADMIN'">
          <el-input v-model="form.score" autocomplete="off" :disabled = "user.role != 'ADMIN'"></el-input>
        </el-form-item>
        <el-form-item prop="num" label="上课人数" :disabled = "user.role != 'ADMIN'">
          <el-input v-model="form.num" autocomplete="off" :disabled = "user.role != 'ADMIN'"></el-input>
        </el-form-item>
        <el-form-item prop="room" label="上课教室" :disabled = "user.role != 'ADMIN'">
